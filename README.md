# Hai, Saya Andhika Rikio**

Saya adalah seorang programmer yang telah menekuni dunia pengembangan perangkat lunak sejak tahun 2019. **Dengan lebih dari lima tahun pengalaman**, saya telah membangun keterampilan dalam berbagai teknologi, mulai dari pengembangan aplikasi web dan mobile hingga pembuatan API dan sistem backend. Keahlian dan dedikasinya dalam menguasai berbagai bahasa pemrograman dan framework memungkinkan saya untuk menciptakan solusi teknologi yang inovatif dan efektif, menghadirkan pengalaman terbaik bagi pengguna. Seiring berjalannya waktu, Saya terus mengasah kemampuan dan beradaptasi dengan perkembangan dunia teknologi yang semakin pesat! 🚀
...
| **DevOps**              | ![Nginx](https://skillicons.dev/icons?i=nginx) ![Docker](https://skillicons.dev/icons?i=docker) ![Google Cloud Platform](https://skillicons.dev/icons?i=gcp) ![Cloudflare](https://skillicons.dev/icons?i=cloudflare) ![Azure](https://skillicons.dev/icons?i=azure) ![AWS](https://skillicons.dev/icons?i=aws) |
